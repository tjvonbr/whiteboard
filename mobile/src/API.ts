...
export type SearchableWorkoutFilterInput = {
  id?: SearchableIDFilterInput | null,
  routineId?: SearchableIDFilterInput | null,
  userId?: SearchableIDFilterInput | null,
  name?: SearchableStringFilterInput | null,
  ...
  and?: Array< SearchableWorkoutFilterInput | null > | null,
  or?: Array< SearchableWorkoutFilterInput | null > | null,
  not?: SearchableWorkoutFilterInput | null,
};

export type SearchableWorkoutSortInput = {
  field?: SearchableWorkoutSortableFields | null,
  direction?: SearchableSortDirection | null,
};

export enum SearchableWorkoutSortableFields {
  id = "id",
  routineId = "routineId",
  userId = "userId",
  name = "name",
...
export type SearchableWorkoutConnection = {
  __typename: "SearchableWorkoutConnection",
  items?:  Array<Workout | null > | null,
  nextToken?: string | null,
  total?: number | null,
};
...
export type ListWorkoutsInDateRangeQueryVariables = {
  start?: string,
  end?: string | null,
};

export type ListWorkoutsInDateRangeQuery = {
  listWorkoutsInDateRange?:  Array< {
    __typename: "Workout",
    id: string,
    routineId: string,
    routine?:  {
...
export type SearchWorkoutsQueryVariables = {
  filter?: SearchableWorkoutFilterInput | null,
  sort?: SearchableWorkoutSortInput | null,
  limit?: number | null,
  nextToken?: string | null,
  from?: number | null,
};

export type SearchWorkoutsQuery = {
  searchWorkouts?:  {
    __typename: "SearchableWorkoutConnection",
    items?:  Array< {
      __typename: "Workout",
